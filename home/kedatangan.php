    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        echo"   <div class='container-fluid col-sm-12 col-md-12 col-lg-12 col-xl-12 panel panel-primary' style='margin-top: 100px;margin-left: 20px'>
                    <div class='row' style='margin-left: 20px;margin-bottom: 20px'>
                        <h3>PENDAFTARAN KEDATANGAN</h3>
                        <h6>silahkan masukkan berkas</h6>
                        
                        <form method='post' enctype='multipart/form-data'>
                            
                                <label>SURAT PINDAH</label><br>
        ...
        if (isset($_POST['update'])) {
            ...
            if ($u_image1=='') {
                ...
                move_uploaded_file($image_tmp1, "../files/surat_pindah/$u_image1");
                ...
                move_uploaded_file($image_tmp5, "../files/scan_kk/$u_image5");
                move_uploaded_file($image_tmp6, "../files/ktp_e/$u_image6");
                move_uploaded_file($image_tmp7, "../files/surat_kuasa/$u_image7");
                               
                
                $insert_track = "INSERT INTO perjalanan (user_nik, nama_data, daftar, upload, proses, selesai) VALUES ('$user_nik', 'Kedatangan', 'Terdaftar', 'Telah Diupload', 'Masih Dalam Proses', 'Belum')";
                $run = mysqli_query($con, $insert_track);
                $insert = "INSERT INTO data (user_nik, nama_data, file_1, file_2, file_3, file_4, file_5, file_6, file_7, file_8, file_9, file_10, file_11, file_12, file_13, file_14) VALUES ('$user_nik', 'kedatangan', '/files/surat_pindah/$u_image1', '/files/surat_nikah/$u_image2', '/files/akta_lahir/$u_image3', '/files/ijasah/$u_image4', '/files/scan_kk/$u_image5', '/files/ktp_e/$u_image6', '/files/surat_kuasa/$u_image7', '-', '-', '-', '-', '-', '-', '-')";
                $run = mysqli_query($con, $insert);
    
                if ($run) {
                    echo "<script>alert('Data Telah diupload')</script>";
                    echo "<script>window.open('kedatangan.php', '_self')</script>";
                }
            }
        }
        ?>
