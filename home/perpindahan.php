    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        echo"   <div class='container-fluid col-sm-12 col-md-12 col-lg-12 col-xl-12 panel panel-primary' style='margin-top: 100px;margin-left: 20px'>
                    <div class='row' style='margin-left: 20px;margin-bottom: 20px'>
                        ...
                        <form method='post' enctype='multipart/form-data'>
                                ...
                                <label>FORMULIR PERMOHONAN PINDAH</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
                                <input type='file' name='u_image3' size='60'></br>
                                </label></br>

                                <label>FOTO COPY SURAT NIKAH JIKA MEMILIKI</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
                                <input type='file' name='u_image4' size='60'></br>
                                </label></br>

                                <label>FOTO COPY SURAT CERAI JIKA MEMILIKI</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
                                <input type='file' name='u_image5' size='60'></br>
                                </label></br>

                                <label>SURAT PERNYATAAN PERSETUJUAN SUAMI/ISTRI</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
                                <input type='file' name='u_image6' size='60'></br>
                                </label></br>

                                <label>FORMULIR PINDAH ULANG</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
                                <input type='file' name='u_image7' size='60'></br>
                                </label></br>

                                <label>FORMULIR BATAL PINDAH</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
        ...
        if (isset($_POST['update'])) {
            ...
            if ($u_image1=='') {
                ...
                move_uploaded_file($image_tmp1, "../files/kk/$u_image1");
                move_uploaded_file($image_tmp2, "../files/KTP/$u_image2");
                move_uploaded_file($image_tmp3, "../files/formulir_permohonan/$u_image3");
                move_uploaded_file($image_tmp4, "../files/fc_surat_nikah/$u_image4");
                move_uploaded_file($image_tmp5, "../files/fc_surat_cerai/$u_image5");
                move_uploaded_file($image_tmp6, "../files/surat_pernyataan_persetujuan/$u_image6");
                move_uploaded_file($image_tmp7, "../files/formulir_pindah_ulang/$u_image7");
                move_uploaded_file($image_tmp8, "../files/batal_pindah/$u_image8");
                               
                
                $insert_track = "INSERT INTO perjalanan (user_nik, nama_data, daftar, upload, proses, selesai) VALUES ('$user_nik', 'Perpindahan', 'Terdaftar', 'Telah Diupload', 'Masih Dalam Proses', 'Belum')";
                $run = mysqli_query($con, $insert_track);
                $insert = "INSERT INTO data (user_nik, nama_data, file_1, file_2, file_3, file_4, file_5, file_6, file_7, file_8, file_9, file_10, file_11, file_12, file_13, file_14) VALUES ('$user_nik', 'Perpindahan', '/files/kk/$u_image1', '/files/KTP/$u_image2', '/files/formulir_permohonan/$u_image3', '/files/fc_surat_nikah/$u_image4', '/files/fc_surat_cerai/$u_image5', '/files/surat_pernyataan_persetujuan/$u_image6', '/files/formulir_pindah_ulang/$u_image7', '/files/batal_pindah/$u_image8', '-', '-', '-', '-', '-', '-')";
                $run = mysqli_query($con, $insert);
    
                if ($run) {
                    echo "<script>alert('Data Telah diupload')</script>";
                    echo "<script>window.open('perpindahan.php', '_self')</script>";
                }
            }
        }
        ?>
