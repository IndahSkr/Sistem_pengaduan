    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        echo"   <div class='container-fluid col-sm-12 col-md-12 col-lg-12 col-xl-12 panel panel-primary' style='margin-top: 100px;margin-left: 20px'>
                    <div class='row' style='margin-left: 20px;margin-bottom: 20px'>
                        ...
                        <form method='post' enctype='multipart/form-data'>
                                ...
                                <label>KTP ELEKTRONIK</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
                                <input type='file' name='u_image2' size='60'></br>
                                </label></br>
                            
                                <label>FOTO/SCREENSHOT BUKTI ERROR DARI INSTANSI TUJUAN</label></br>
                                <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i></br>
        ...
        if (isset($_POST['update'])) {
            ...
            if ($u_image1=='') {
                ...
                move_uploaded_file($image_tmp2, "../files/ktp_el/$u_image2");
                move_uploaded_file($image_tmp3, "../files/ss/$u_image3");
                               
                
                $insert_track = "INSERT INTO perjalanan (user_nik, nama_data, daftar, upload, proses, selesai) VALUES ('$user_nik', 'Update Data', 'Terdaftar', 'Telah Diupload', 'Masih Dalam Proses', 'Belum')";
                $run = mysqli_query($con, $insert_track);
                $insert = "INSERT INTO data (user_nik, nama_data, file_1, file_2, file_3, file_4, file_5, file_6, file_7, file_8, file_9, file_10, file_11, file_12, file_13, file_14) VALUES ('$user_nik', 'Update Data', 'files/kk/$u_image1', 'files/ktp_el/$u_image2', 'files/ss/$u_image3', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-')";
                $run = mysqli_query($con, $insert);
    
                if ($run) {
                    echo "<script>alert('Data Telah diupload')</script>";
                    echo "<script>window.open('update_data.php', '_self')</script>";
                }
            }
        }
        ?>
