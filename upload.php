...
<body>
	...
	echo "
		<div class='card'>
			...
			<form method='post' enctype='multipart/form-data'>
				<label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i>Pilih Profile
	...
	if (isset($_POST['update'])) {
		...
		if ($u_image=='') {
			echo "<script>alert('Tolong pilih Data)</script>";
			echo "<script>window.open('upload.php', '_self')</script>";
			exit();
		}else{
			move_uploaded_file($image_tmp, "images/$u_image.$random_number");

			$update = "UPDATE users set user_profile='images/$u_image.$random_number' where user_hp='$user'";
